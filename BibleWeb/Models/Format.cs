    ...
    public static class Format
    {
        public static string PartOfSpeech(PartOfSpeechData partOfSpeech)
        {
            return partOfSpeech switch
            {
                ...
                PartOfSpeechData.DefiniteArticle => "Definite Article",
                PartOfSpeechData.DemonstrativePronoun => "Pronoun - Demonstrative",
                PartOfSpeechData.IndefinitePronoun => "Pronoun - Indefinite",
                PartOfSpeechData.PersonalPronoun => "Pronoun - Personal",
                PartOfSpeechData.RelativePronoun => "Pronoun - Relative",
